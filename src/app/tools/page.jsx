        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-emerald-300/70">
              Press <kbd className="px-2 py-1 text-xs border border-emerald-400/30 rounded bg-emerald-500/10 text-emerald-300">⌘K</kbd> or <kbd className="px-2 py-1 text-xs border border-emerald-400/30 rounded bg-emerald-500/10 text-emerald-300">Ctrl+K</kbd> to search all tools instantly
            </p>
          </div>
        </div>
      </div>
